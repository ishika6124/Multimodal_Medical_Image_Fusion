...
CT_DATASET  = Path("/home/teaching/group46/CT_dataset")
OUTPUT_ROOT = Path("/home/teaching/group46/CT_embeddings")
...
def run(split: str, image_size: int, batch_size: int,
    ...
    # ── dataset ────────────────────────────────────────────────────────────── #
    dataset = CTDataset(split=split, image_size=image_size)
